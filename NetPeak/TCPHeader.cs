...
namespace nsNetPeak
{
    ...
    {
        //TCP header fields
        public ushort usSourcePort;              //Sixteen bits for the source port number
        public ushort usDestinationPort;         //Sixteen bits for the destination port number
        ...
        public string Flags
        {
            get
            {
                ...
                {
                    strFlags = strFlags.Remove(strFlags.Length - 2, 1);
                }
